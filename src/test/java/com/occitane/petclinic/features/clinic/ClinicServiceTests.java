...
class ClinicServiceTests {
	...
	void shouldFindVets() {
		...
		assertThat(vet.getspecialities()).hasSize(2);
		Assertions.assertThat(vet.getspecialities().get(0).getName()).isEqualTo("dentistry");
		Assertions.assertThat(vet.getspecialities().get(1).getName()).isEqualTo("surgery");
	}
